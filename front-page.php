   ...
   <!--     <h1>מרכז טיפולי - מורן סבתו</h1>
    ...
    <section class="intro">
        <div class="intro-content">
            <h2>ברוכים הבאים</h2>
            <p>
                  וטיפול בפגיעות מיניות - פוגעים ונפגעים. מרכז טיפולי בניהול מורן סבתו, מטפלת מינית, זוגית ומשפחתית מוסמכת המתמחה בטיפול במגוון תחומים: טיפול זוגי, משפחתי, טיפול בטראומה.
